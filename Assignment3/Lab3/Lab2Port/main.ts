...
module main {
    //The global arrays
    export var rooms = ["Room0", "Room1", "Room2", "Room3", "Room4"];
    export var guests = ["Guest0", "Guest1", "Guest2"];
    export var weapons = ["Weapon0", "Weapon1", "Weapon2"];
   ...
   //dom objects
    ...
    function updateComputerWon() {
        var history = (<any>sessionStorage).history; //document.getElementById("history").getAttribute("data-history");
        var wins = (<any>sessionStorage).win;  //document.getElementById("historywl").getAttribute("data-w");

        (<any>sessionStorage).win = (parseInt(wins) + 1).toString(); //document.getElementById("historywl").setAttribute("data-w", (parseInt(wins) + 1).toString());
        ...
        (<any>sessionStorage).history = history; //document.getElementById("history").setAttribute("data-history", history);
    ...
    function updateComputerLoss() {
        var history = (<any>sessionStorage).history; //document.getElementById("history").getAttribute("data-history");
        var losses = (<any>sessionStorage).loss; // document.getElementById("historywl").getAttribute("data-l");

   

        (<any>sessionStorage).loss = (parseInt(losses) + 1).toString(); //document.getElementById("historywl").setAttribute("data-l", (parseInt(losses) + 1).toString());
    ...
    function createSecretAndHandoutCards() {
        ...
        for (var i = 0; i < rooms.length - 1; i++)
            ...
            else compCards.push(clonedArray.pop());
    ...
    function toggleHistory() {
        ...
        if (historyInnerHtml.length == 0) {
            ...
            var history = (<any>sessionStorage).history;
    ...
    window.onload = function () {
        ...
        (<any>sessionStorage).history = " ";
        (<any>sessionStorage).win = "0";
        (<any>sessionStorage).loss = "0";
